...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\BienRepository' => function () {
...
}, 'App\\Repository\\ContratRepository' => function () {
    return ($this->privates['App\Repository\ContratRepository'] ?? $this->load('getContratRepositoryService.php'));
...
}, 'App\\Repository\\LocaliteRepository' => function () {
    return ($this->privates['App\Repository\LocaliteRepository'] ?? $this->load('getLocaliteRepositoryService.php'));
}, 'App\\Repository\\PaiementRepository' => function () {
    return ($this->privates['App\Repository\PaiementRepository'] ?? $this->load('getPaiementRepositoryService.php'));
...
}, 'App\\Repository\\TypebienRepository' => function () {
    return ($this->privates['App\Repository\TypebienRepository'] ?? $this->load('getTypebienRepositoryService.php'));
}))));
