...
class Bien extends \App\Entity\Bien implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'nombien', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'prix', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'etat', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'typebien', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'localite', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'images', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'reservation', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'contrat'];
        }
     ...
     * {@inheritDoc}
     */
    public function setNombien(string $nombien): \App\Entity\Bien
    {
     ...
     * {@inheritDoc}
     */
    public function setEtat(int $etat): \App\Entity\Bien
    {
