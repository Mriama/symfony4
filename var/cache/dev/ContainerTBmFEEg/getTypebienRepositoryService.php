...
// Returns the private 'App\Repository\TypebienRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TypebienRepository.php';

return $this->privates['App\Repository\TypebienRepository'] = new \App\Repository\TypebienRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
